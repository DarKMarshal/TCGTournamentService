...
import com.darkmarshal.tournamentservice.DTO.Event.PlayerMatchStats;
...
@Service
public class TDFParseService implements IParseService {

    private final IPlayerRepository playerRepository;

    public TDFParseService(IPlayerRepository playerRepository) {
        this.playerRepository = playerRepository;
    }

    @Override
    public Event parseEventFile(String filePath) throws Exception {
    ...
    private String determineTournamentType(Document doc) {
    ...
    private Map<String, Player> parsePlayers(Document doc) {
    ...
    private Map<String, PlayerMatchStats> calculatePlayerStats(Document doc) {
    ...
    private List<Tournament> parseDivisions(Document doc, Map<String, Player> playerMap,
    ...
    private AgeDivision getAgeDivisionFromCategory(String category) {
    ...
    private List<Result> parseStandings(Element pod, Map<String, Player> playerMap,
                                              Map<String, PlayerMatchStats> playerStats) {
